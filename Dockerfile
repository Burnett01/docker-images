...
RUN apk --update --no-cache add \
    ...
    php8-ftp php8-bcmath php8-pecl-memcached php8-gmp php8-pdo_sqlite php8-sodium php8-sysvsem \
    php8-pcntl php8-fileinfo php8-iconv php8-posix php8-gd php8-soap php8-pecl-xdebug php8-simplexml php8-json
